...
通过 MCP 工具向一位外部助手发出协助请求，请对方在一个上下文干净的、运行时隔离的、独立环境中，执行网络搜索、网页读取、长文本的阅读理解等任务。
...
- gemini-2.5-pro: 擅长超长文档的阅读理解、文献整理与汇总、中长篇小说的修改与撰写、复杂网络搜索任务的执行等
- gemini-2.5-flash: 擅长网络搜索、长文档的阅读理解、创意写作，等等
